class Bus {
    ...
    animate() {
        ...
        drawRectCenter(screen.x, screen.y, bodyLength*zoom, 30*zoom, this.angle, this.color)
        drawArrow(screen.x, screen.y, screen.x+dir.x, screen.y+dir.y, 5*zoom, "black", 1, "square", 10*zoom)
    }
    ...
    nextNode() {
        ...
        // Auto move bus
        let adjNodes = network.lines[this.color].graph.adjacent(this.start);
